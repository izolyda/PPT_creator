...
namespace PPT_creator
{
    public class PPTX
    {
        ...
        public PresentationDocument getPresentationDoc()
        {
            return this.presentationDoc;
        }

        public void setPresentationDoc(PresentationDocument presDoc)
        {
            presentationDoc = presDoc;
        }
        ...
        public static void InsertNewSlide(PresentationDocument presentationDocument, int position, string slideTitle)
        {
            ...
            titleShape.TextBody = new TextBody(new Drawing.BodyProperties(),
                    new Drawing.TableCellTextStyle(),
            ...
            TextBody body =  bodyShape.TextBody = new TextBody(new Drawing.BodyProperties(),
                    new Drawing.TableCellTextStyle(),
                    new Drawing.Paragraph());

            //insert a paragraph with custom text*******
            Paragraph para = body.AppendChild(new Paragraph());
            Run run = para.AppendChild(new Run());
            run.AppendChild(new D.Text("HELLO"));
